...
from utilities.langchain_helpers import mathpix_2_question, mathpix_2_simplified
...
def assemble_prompts():
    ...
    print(f"\n\nWOLFRAM: {wolfram}")
#    tasks = [mathpix_2_text(chat, data=MATHPIX_DATA),
#             execute_wolfram_query(task=WOLFRAM_DATA)]
