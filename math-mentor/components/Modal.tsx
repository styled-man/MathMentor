...
const Modal = ({ userProblem, yPosition, infoForUser, moreInfoForUser, youtubeLink, youtubeLinkTitle, setIsModalSmall, isModalSmall }: IModal) => {
  return (
    <div
      style={{
...
const ModalContainer = (props: IModalContainer) => {
  ...
  return (
    <>
      ...
      {isModalHidden || <Modal {...props} isModalSmall={isModalSmall} setIsModalSmall={setIsModalSmall} />}
    </>
  )
}
